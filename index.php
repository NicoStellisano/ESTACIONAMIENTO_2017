...
<script type="text/javascript" src="funciones.js"></script>
  ...
  <form action="index.php" method="post">
   ...
   <div class="row">
    <div class="col-md-offset-2 col-md-4 col-xs-offset-2 col-xs-3"> <b style="text-align:center">Usuario:</b></div><div><input type="text" name="usuario" required ></div><br></div>
   <div class="row">
    <div class="col-md-offset-2 col-md-4 col-xs-offset-2 col-xs-3"> <b style="text-align:center">Contraseña:</b></div><div><input type="password" name="contraseña" required ></div></div>

      
				<br>
        <div class="row">
           <div class="col-md-offset-5 col-md-7"> <input style="color:white;background-color:#191919;border-color:grey;" type="submit" value="Entrar"></div><br></div>
</form>
<br>
</div>
</div>
